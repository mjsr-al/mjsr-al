...
def main(args):
    ...
    results = open('results/results_'+str(args['method_type'])+"_"+args['dataset'] +'_main'+str(args['CYCLES'])+str(args['total'])+'.txt','w')
    ...
    # name of csv file 
    filename = "results/results_" + args['group'] + '_' + str(args['attempt']) + ".csv"
